...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var ai, config, model, contents, response, fileIndex, _a, response_1, response_1_1, chunk, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ai = new genai_1.GoogleGenAI({
                        apiKey: process.env["AIzaSyB_Z8vy8aBsabYTQD1EwXUQaaJIc3bTUls"],
                    });
                    config = {
                        thinkingConfig: {
                    ...
                    contents = [
                        {
                            ...
                            parts: [
                                {
                                    text: "Hello i need you help with my recepies blog ",
                                },
                            ],
                        },
                    ];
